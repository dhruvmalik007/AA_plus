/**
this is an example implementation of elliptical curve signature generation and verification functions 
@credits to trampoline project for the implementation: https://github.com/plusminushalf/trampoline-example/tree/fingerprint
